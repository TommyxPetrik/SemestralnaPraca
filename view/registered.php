    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-primary text-dark shadow-none ml-md-4" onclick="location.href='login.php'">Sign in</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row h-100 align-items-center">
            <div class="col-md-7">
                <div class="header-content">
                    ...
                    <h4 class="header-subtitle">Successfully registered</h4>
                    <p>Now you <strong>Sign in</strong> and can continue to choose one of your plans we provide.</p>
                    <button class="btn btn-outline-light btn-flat" onclick="location.href='login.php'">Sign in</button>
                </div>
            </div>
        </div>
    </div>
