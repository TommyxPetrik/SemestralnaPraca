                ...
                <div class="tabs-container">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="users">
                            ...
                            <form action="../controllers/spracuj_newplan.php" method="post" class="header-form" name="user_change" id="user_change" style="width: 300px">
                                <div class="body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" placeholder="Bandwidth*" name="bandwidth" id="bandwidth">
                                    </div>
                                    <div class="head">Number of websites</div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" placeholder="Number of websites*" name="websites" id="websites">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Customization" name="customization" id="customization">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Integration" name="integration" id="integration">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Support" name="support" id="support">
                                    </div>
                                </div>
                        </div>
                        <div class="footer">
                            <button class="btn btn-primary btn-block" style="width: 300px">Add</button>
                        </div>
                        </form>
                    </div>
